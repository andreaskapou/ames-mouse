...
bs_treat_files  <- c("../datasets/BEATSON/BS-Seq/13L_N_young.CpG_context.aggregate",
...
rna_treat_files <- "../datasets/BEATSON/RNA-Seq/processed/RNA_Seq_FPKM_X13L_N_young.bed"
...
# Store the results
# -----------------------------------------
filename <- paste0("../files/diff_corr_df_young_N_young", 
