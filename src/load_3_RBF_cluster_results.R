...
##----------------DF OLD mice results --------------
load("../files/cluster_smooth_df_old_MonFeb222335.RData")
...
for (i in 1:K){
  ...
  #write(df_old_gene_ids[[i]], paste0("../results/df_old_3_rbf", K, "_clust_", i, "_", format(Sys.time(), "%a%b%d%H%M"), ".txt"))
}


##-----------------DF YOUNG mice results ------------
load("../files/cluster_smooth_df_young_MonFeb222331.RData")
...
for (i in 1:K){
  ...
  #write(df_young_gene_ids[[i]], paste0("../results/df_young_3_rbf", K, "_clust_", i, "_", format(Sys.time(), "%a%b%d%H%M"), ".txt"))
}
...
load("../files/cluster_smooth_N_old_MonFeb222343.RData")
...
for (i in 1:K){
  ...
  #write(N_old_gene_ids[[i]], paste0("../results/N_old_3_rbf", K, "_clust_", i, "_", format(Sys.time(), "%a%b%d%H%M"), ".txt"))
}
...
load("../files/cluster_smooth_N_young_MonFeb222337.RData")
...
for (i in 1:K){
  ...
  #write(N_young_gene_ids[[i]], paste0("../results/N_young_3_rbf", K, "_clust_", i, "_", format(Sys.time(), "%a%b%d%H%M"), ".txt"))
}
