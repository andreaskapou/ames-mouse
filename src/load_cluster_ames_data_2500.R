...
# -----------------------------------------
do_file <- "../files/cluster_df_old_2500_WedMay112011.RData"
dy_file <- "../files/cluster_df_young_2500_WedMay112005.RData"
no_file <- "../files/cluster_N_old_2500_WedMay112013.RData"
ny_file <- "../files/cluster_N_young_2500_WedMay112006.RData"
...
for (i in 1:K){
  ...
  #write(do_gene_ids[[i]], paste0("../results/final_do_2500_", K, "_4_clust_", i, ".txt"))
}
...
for (i in 1:K){
  ...
  #write(dy_gene_ids[[i]], paste0("../results/final_dy_2500_", K, "_4_clust_", i, ".txt"))
}
...
for (i in 1:K){
  ...
  #write(no_gene_ids[[i]], paste0("../results/final_no_2500_", K, "_4_clust_", i, ".txt"))
}
...
for (i in 1:K){
  ...
  #write(ny_gene_ids[[i]], paste0("../results/final_ny_2500_", K, "_4_clust_", i, ".txt"))
}
...
for (k in 1:K){
  ...
  #write(comm_do_ids[[k]], paste0("../results/final_comm_do_2500_", K, "_4_clust_", k, ".txt"))
  comm_dy_ids[[k]] <- Reduce(intersect, list(inters_cell, dy_gene_ids[[k]]))
  #write(comm_dy_ids[[k]], paste0("../results/final_comm_dy_2500_", K, "_4_clust_", k, ".txt"))
  comm_no_ids[[k]] <- Reduce(intersect, list(inters_cell, no_gene_ids[[k]]))
  #write(comm_no_ids[[k]], paste0("../results/final_comm_no_2500_", K, "_4_clust_", k, ".txt"))
  comm_ny_ids[[k]] <- Reduce(intersect, list(inters_cell, ny_gene_ids[[k]]))
  #write(comm_ny_ids[[k]], paste0("../results/final_comm_ny_2500_", K, "_4_clust_", k, ".txt"))
}
