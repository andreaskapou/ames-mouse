...
##----------------DF OLD mice results --------------
load("../files/cluster_small_region_df_old_MonFeb222312.RData")
...
for (i in 1:K){
  ...
  #write(df_old_gene_ids[[i]], paste0("../results/df_old_small_region", K, "_clust_", i, "_", format(Sys.time(), "%a%b%d%H%M"), ".txt"))
}


##-----------------DF YOUNG mice results ------------
load("../files/cluster_small_region_df_young_MonFeb222307.RData")
...
for (i in 1:K){
  ...
  #write(df_young_gene_ids[[i]], paste0("../results/df_young_small_region", K, "_clust_", i, "_", format(Sys.time(), "%a%b%d%H%M"), ".txt"))
}
...
load("../files/cluster_small_region_N_old_MonFeb222315.RData")
...
for (i in 1:K){
  ...
  #write(N_old_gene_ids[[i]], paste0("../results/N_old_small_region", K, "_clust_", i, "_", format(Sys.time(), "%a%b%d%H%M"), ".txt"))
}
...
load("../files/cluster_small_region_N_young_MonFeb222312.RData")
...
for (i in 1:K){
  ...
  #write(N_young_gene_ids[[i]], paste0("../results/N_young_small_region", K, "_clust_", i, "_", format(Sys.time(), "%a%b%d%H%M"), ".txt"))
}
