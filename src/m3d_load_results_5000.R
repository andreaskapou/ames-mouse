...
load("../datasets/BEATSON/Diff_Meth/M3D_5000_DO_NO.RData")
load("../datasets/BEATSON/Diff_Meth/genes_5000.RData")
...
load("../datasets/BEATSON/Diff_Meth/M3D_5000_DY_DO.RData")
load("../datasets/BEATSON/Diff_Meth/genes_5000.RData")
...
load("../datasets/BEATSON/Diff_Meth/M3D_5000_DY_NY.RData")
load("../datasets/BEATSON/Diff_Meth/genes_5000.RData")
...
load("../datasets/BEATSON/Diff_Meth/M3D_5000_NO_NY.RData")
load("../datasets/BEATSON/Diff_Meth/genes_5000.RData")
...
save(diff_genes_do_no, diff_genes_dy_do, diff_genes_dy_ny, diff_genes_no_ny,
     file = "../files/diff_genes_5000.RData")